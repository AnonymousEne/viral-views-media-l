...
export default function MediaUpload({ 
  ...
  const [showVoiceEffects, setShowVoiceEffects] = React.useState<boolean>(false)
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white/10 backdrop-blur-lg rounded-xl border border-white/20">
      ...
      {/* Optional Voice Effects Toggle */}
      <div className="mb-4 flex items-center gap-3">
        <input
          type="checkbox"
          id="voiceEffects"
          checked={showVoiceEffects}
          onChange={() => setShowVoiceEffects((v: boolean) => !v)}
          className="accent-pink-500"
        />
        <label htmlFor="voiceEffects" className="text-white font-medium cursor-pointer">
          Enable Auto-Tune & Key Detection (optional)
        </label>
      </div>
      {showVoiceEffects && (
        <div className="mb-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setMetadata((prev: typeof metadata) => ({ ...prev, title: e.target.value }))}
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setMetadata((prev: typeof metadata) => ({ ...prev, description: e.target.value }))}
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setMetadata((prev: typeof metadata) => ({ 
                    ...prev, 
              ...
              <div>
                ...
                <input
                  type="text"
                  value={metadata.tags}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setMetadata((prev: typeof metadata) => ({ ...prev, tags: e.target.value }))}
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setMetadata((prev: typeof metadata) => ({ ...prev, isPublic: e.target.checked }))}
