...
export function Navbar() {
  ...
  const navigation = [
    ...
    { name: 'Cypher Test', href: '/cypher-test', icon: Users },
    { name: 'AI Analysis', href: '/ai', icon: Trophy },
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <Link href="/" className="text-2xl font-bold bg-gradient-to-r from-pink-400 to-purple-600 bg-clip-text text-transparent hover:opacity-90 transition-opacity">
              VIRAL VIEWS
            </Link>
          </div>
